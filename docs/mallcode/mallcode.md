...
There is a 3 second lock for players to not be interrupted, buy taking control of the morse code input. 3 seconds after the last signal sent. During this period players can't control the morse code input. After the lock is over any player can start using it.